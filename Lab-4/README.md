...
Вывод: всё работает, анонсируемые сети доступны. Настройка проще, чем iBGP, но нужно продумать возможность масштабирования.<br>
P.S. Конфиги eBGP приложены в архиве.